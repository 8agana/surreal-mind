...
# Debug script for think_search with low threshold and debug logging
echo "=== Debug think_search with Low Threshold ==="
...
echo "1. Creating test thought with debug logging..."
{
    ...
    echo '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"think_convo","arguments":{"content":"Artificial intelligence and machine learning are transforming technology","injection_scale":3,"significance":0.8}}}'
    sleep 3
...
echo "2. Testing search with VERY low threshold (0.01)..."
{
    echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"test","version":"1.0"}}}'
    echo '{"jsonrpc":"2.0","method":"notifications/initialized"}'
    echo '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"think_search","arguments":{"content":"artificial intelligence","top_k":5,"sim_thresh":0.01}}}'
    sleep 3
...
echo "3. Testing search with exact same content..."
{
    echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"test","version":"1.0"}}}'
    echo '{"jsonrpc":"2.0","method":"notifications/initialized"}'
    echo '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"think_search","arguments":{"content":"Artificial intelligence and machine learning are transforming technology","top_k":5,"sim_thresh":0.01}}}'
    sleep 3
} | SURR_EMBED_PROVIDER=candle cargo run --bin surreal-mind 2>&1 | grep -E 'total|results|similarity|dimension|error'
