...
async fn main() -> Result<()> {
    ...
    println!("Connected successfully to namespace '{}' and database '{}'", ns, dbname);
    println!("Inserting test data...\n");

    // Insert Competition
    println!("Creating competition: 2025 Fall Fling");
    let _ = db.query(
        "CREATE competition:fall_fling_2025 SET
            name = '2025 Fall Fling',
            venue = 'Line Creek Community Center',
            start_date = d'2025-10-25T10:00:00Z',
            end_date = d'2025-10-25T18:35:00Z',
            notes = 'First production test of photography database'"
    ).await?;

    // Insert Events
    println!("Creating events...");
    let event_queries = vec![
        "CREATE event:e10 SET competition = competition:fall_fling_2025, event_number = 10, time_slot = '1:15-1:40', notes = 'Corinne Ruiz Peace'",
        "CREATE event:e23 SET competition = competition:fall_fling_2025, event_number = 23, time_slot = '3:25-3:55', notes = 'Cecilia Ruiz Peace'",
        "CREATE event:e24 SET competition = competition:fall_fling_2025, event_number = 24, time_slot = '3:25-3:55', notes = 'Harlee Carrico'",
        "CREATE event:e31_l SET competition = competition:fall_fling_2025, event_number = 31, split_ice = 'L', time_slot = '5:15-5:30', notes = 'Celeste Ruiz Peace - Line Creek ice'",
        "CREATE event:e33_z SET competition = competition:fall_fling_2025, event_number = 33, split_ice = 'Z', time_slot = '5:15-5:30', notes = 'Cecilia Ruiz Peace - Zamboni ice'",
    ];
    ...
    let skater_queries = vec![
        "CREATE skater:ruiz_peace_corinne SET first_name = 'Corinne', last_name = 'Ruiz Peace', notes = 'Part of Ruiz Peace family delivery unit'",
        "CREATE skater:ruiz_peace_cecilia SET first_name = 'Cecilia', last_name = 'Ruiz Peace', notes = 'Part of Ruiz Peace family delivery unit'",
        "CREATE skater:ruiz_peace_celeste SET first_name = 'Celeste', last_name = 'Ruiz Peace', notes = 'Part of Ruiz Peace family delivery unit'",
        "CREATE skater:carrico_harlee SET first_name = 'Harlee', last_name = 'Carrico', notes = 'VIP skater - individual delivery'",
    ];
    ...
    let _ = db.query(
        "CREATE client:ruiz_peace_parent SET
            first_name = 'Ruiz Peace',
            last_name = 'Family',
            email = 'example@example.com',
            notes = 'Primary contact for Ruiz Peace family'"
    ).await?;

    // Insert Family
    println!("Creating family unit...");
    let _ = db.query(
        "CREATE family:ruiz_peace SET
            name = 'Ruiz Peace',
            primary_contact = client:ruiz_peace_parent,
            delivery_email = 'example@example.com',
            notes = '3 skaters - Corinne, Cecilia, Celeste'"
    ).await?;
    ...
    let shotlog_queries = vec![
        "CREATE shotlog:ruiz_peace_corinne_e10 SET skater = skater:ruiz_peace_corinne, event = event:e10, raw_count = 0, picked_count = 0, borderline_count = 0, creative_count = 0, notes = 'Awaiting culling'",
        "CREATE shotlog:carrico_harlee_e24 SET skater = skater:carrico_harlee, event = event:e24, raw_count = 0, picked_count = 0, borderline_count = 0, creative_count = 0, notes = 'Awaiting culling'",
    ];
