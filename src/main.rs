...
async fn main() -> Result<()> {
    ...
    if !config.runtime.mcp_no_log {
        ...
        info!(
            "🛠️  Loaded 16 MCP tools: think, wander, maintain, rethink, corrections, test_notification, remember, howto, call_gem, call_cc, call_warp, call_vibe, search, call_status, call_jobs, call_cancel"
        );
    }
